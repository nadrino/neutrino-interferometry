...
def run_once(backend_name="numpy"):
    ...
    P_full = osc.probability(L_km=L_km, E_GeV=E, alpha=None, beta=None)
    P_mue = osc.probability(L_km=L_km, E_GeV=E, alpha=1, beta=0)
    P_mumu = osc.probability(L_km=L_km, E_GeV=E, alpha=1, beta=1)
